                ...
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">                     
                        ...
                        <li>
                         ...
                         <li>
                            <a href="typefood_list"><i class="fa fa-list fa-fw"></i>Loại đồ ăn<span class="fa arrow"></span></a>
                            <ul class="nav nav-third-level">
                                <li>
                                    <a href="typefood_list">Danh sách loại đồ ăn</a>
                                </li>
                                <li>
                                    <a href="typefood_addnew">Thêm mới loại đồ ăn</a>
                                </li>                                                         
                            </ul>
                        </li>
